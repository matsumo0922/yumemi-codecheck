...
data class RepositoryDetail(
    ...
    val templateRepository: RepositoryDetail?,
...
fun RepositoryDetailEntity.translate() = RepositoryDetail(
...
fun RepositoryDetailEntity.License.translate() = RepositoryDetail.License(
    key = this.key,
    name = this.name,
    nodeId = this.nodeId,
    spdxId = this.spdxId,
...
fun RepositoryDetailEntity.Organization.translate() = RepositoryDetail.Organization(
...
fun RepositoryDetailEntity.Owner.translate() = RepositoryDetail.Owner(
    avatarUrl = this.avatarUrl,
    eventsUrl = this.eventsUrl,
    followersUrl = this.followersUrl,
    followingUrl = this.followingUrl,
...
fun RepositoryDetailEntity.Permissions.translate() = RepositoryDetail.Permissions(
    admin = this.admin,
    pull = this.pull,
    push = this.push
)